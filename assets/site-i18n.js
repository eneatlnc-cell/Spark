...
window.SLI18N = (function () {
  ...
  var dict = {
    en: {
      ...
      "loop.st_vault": "SHIPPED v3.71.3",
      "loop.st_engine": "SHIPPED v3.64.9",
    ...
    zh: {
      ...
      "loop.st_vault": "已交付 v3.71.3",
      "loop.st_engine": "已交付 v3.64.9",
    ...
    ja: {
      ...
      "loop.st_vault": "リリース v3.71.3",
      "loop.st_engine": "リリース v3.64.9",
    ...
    ko: {
      ...
      "loop.st_vault": "출시 v3.71.3",
      "loop.st_engine": "출시 v3.64.9",
    ...
    ar: {
      ...
      "loop.st_vault": "أُصدر v3.71.3",
      "loop.st_engine": "أُصدر v3.64.9",
    ...
    es: {
      ...
      "loop.st_vault": "ENVIADO v3.71.3",
      "loop.st_engine": "ENVIADO v3.64.9",
