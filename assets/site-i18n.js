...
window.SLI18N = (function () {
  ...
  var dict = {
    en: {
      ...
      "loop.st_vault": "SHIPPED v3.60.0",
      "loop.st_engine": "SHIPPED v3.62.0",
    ...
    zh: {
      ...
      "loop.st_vault": "已交付 v3.60.0",
      "loop.st_engine": "已交付 v3.62.0",
    ...
    ja: {
      ...
      "loop.st_vault": "リリース v3.60.0",
      "loop.st_engine": "リリース v3.62.0",
    ...
    ko: {
      ...
      "loop.st_vault": "출시 v3.60.0",
      "loop.st_engine": "출시 v3.62.0",
    ...
    ar: {
      ...
      "loop.st_vault": "أُصدر v3.60.0",
      "loop.st_engine": "أُصدر v3.62.0",
    ...
    es: {
      ...
      "loop.st_vault": "ENVIADO v3.60.0",
      "loop.st_engine": "ENVIADO v3.62.0",
