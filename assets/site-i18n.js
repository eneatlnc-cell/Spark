...
window.SLI18N = (function () {
  ...
  var dict = {
    en: {
      ...
      "loop.st_vault": "SHIPPED v3.66.0",
      "loop.st_engine": "SHIPPED v3.64.4",
    ...
    zh: {
      ...
      "loop.st_vault": "已交付 v3.66.0",
      "loop.st_engine": "已交付 v3.64.4",
    ...
    ja: {
      ...
      "loop.st_vault": "リリース v3.66.0",
      "loop.st_engine": "リリース v3.64.4",
    ...
    ko: {
      ...
      "loop.st_vault": "출시 v3.66.0",
      "loop.st_engine": "출시 v3.64.4",
    ...
    ar: {
      ...
      "loop.st_vault": "أُصدر v3.66.0",
      "loop.st_engine": "أُصدر v3.64.4",
    ...
    es: {
      ...
      "loop.st_vault": "ENVIADO v3.66.0",
      "loop.st_engine": "ENVIADO v3.64.4",
