...
window.SLI18N = (function () {
  ...
  var dict = {
    en: {
      ...
      "loop.st_vault": "SHIPPED v3.71.4",
      "loop.st_engine": "SHIPPED v3.68.2",
    ...
    zh: {
      ...
      "loop.st_vault": "已交付 v3.71.4",
      "loop.st_engine": "已交付 v3.68.2",
    ...
    ja: {
      ...
      "loop.st_vault": "リリース v3.71.4",
      "loop.st_engine": "リリース v3.68.2",
    ...
    ko: {
      ...
      "loop.st_vault": "출시 v3.71.4",
      "loop.st_engine": "출시 v3.68.2",
    ...
    ar: {
      ...
      "loop.st_vault": "أُصدر v3.71.4",
      "loop.st_engine": "أُصدر v3.68.2",
    ...
    es: {
      ...
      "loop.st_vault": "ENVIADO v3.71.4",
      "loop.st_engine": "ENVIADO v3.68.2",
