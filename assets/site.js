...
(function () {
  ...
  var DOWNLOAD = {
    engine: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.64.3/Engine-3.64.3-release.apk",
      ver: "v3.64.3",
      tagEn: "Sovereign social · E2EE", tagZh: "主权社交 · 端到端加密"
    },
    vault: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.64.3/Vault-3.65.0-release.apk",
      ver: "v3.65.0",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var LOOP = [
      { id: "vault",  href: "vault.html",  ic: "shield", name: "VAULT",  nc: "#10B981", men: "the Safe · offline keys",       mzh: "保险箱 · 密钥离线",    st: "ship", sen: "SHIPPED v3.65.0",          szh: "已交付 v3.65.0" },
      { id: "engine", href: "engine.html", ic: "ship",   name: "ENGINE", nc: "#EC4899", men: "the App · sovereign social",      mzh: "应用 · 主权社交",      st: "ship", sen: "SHIPPED v3.64.3",          szh: "已交付 v3.64.3" },
