...
(function () {
  ...
  var DOWNLOAD = {
    engine: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.71.0/Engine-3.65.0-release.apk",
      ver: "v3.65.0",
      tagEn: "Sovereign social · E2EE", tagZh: "主权社交 · 端到端加密"
    },
    vault: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.71.0/Vault-3.71.4-release.apk",
      ver: "v3.71.4",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var LOOP = [
      ...
      { id: "engine", href: "engine.html", ic: "ship",   name: "ENGINE", nc: "#EC4899", men: "the App · sovereign social",      mzh: "应用 · 主权社交",      st: "ship", sen: "SHIPPED v3.65.0",          szh: "已交付 v3.65.0" },
