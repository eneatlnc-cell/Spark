...
(function () {
  ...
  var DOWNLOAD = {
    engine: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.72.1/Engine-3.68.1-release.apk",
      ver: "v3.68.1",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var LOOP = [
      ...
      { id: "engine", href: "engine.html", ic: "ship",   name: "ENGINE", nc: "#EC4899", men: "the App · sovereign social",      mzh: "应用 · 主权社交",      st: "ship", sen: "SHIPPED v3.68.1",          szh: "已交付 v3.68.1" },
