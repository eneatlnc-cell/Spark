...
(function () {
  ...
  var DOWNLOAD = {
    ...
    vault: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.69.0/Vault-3.69.0-release.apk",
      ver: "v3.69.0",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var LOOP = [
      { id: "vault",  href: "vault.html",  ic: "shield", name: "VAULT",  nc: "#10B981", men: "the Safe · offline keys",       mzh: "保险箱 · 密钥离线",    st: "ship", sen: "SHIPPED v3.69.0",          szh: "已交付 v3.69.0" },
