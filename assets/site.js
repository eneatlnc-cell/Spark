...
(function () {
  ...
  var DOWNLOAD = {
    engine: {
      url: "https://github.com/eneatlnc-cell/Spark/releases/download/v3.69.0/Engine-3.64.7-release.apk",
      ver: "v3.64.7",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var LOOP = [
      ...
      { id: "engine", href: "engine.html", ic: "ship",   name: "ENGINE", nc: "#EC4899", men: "the App · sovereign social",      mzh: "应用 · 主权社交",      st: "ship", sen: "SHIPPED v3.64.7",          szh: "已交付 v3.64.7" },
